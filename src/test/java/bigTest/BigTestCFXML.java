...
public class BigTestCFXML {
    ...
    public void controlFlow() throws InterruptedException, FindFailed, SQLException, ClassNotFoundException {
       ...
       /* //PDPreviewFreeCallIE
        webphoneANDagentdesktopANDpowerdialer.PDPreviewFreeCallIE.ssoLoginChrome();
        webphoneANDagentdesktopANDpowerdialer.PDPreviewFreeCallIE.changeStatusToAvailable();
        webphoneANDagentdesktopANDpowerdialer.PDPreviewFreeCallIE.switchToADTab();
        webphoneANDagentdesktopANDpowerdialer.PDPreviewFreeCallIE.runSQLQuery();
        webphoneANDagentdesktopANDpowerdialer.PDPreviewFreeCallIE.agentAcceptCall();
        webphoneANDagentdesktopANDpowerdialer.PDPreviewFreeCallIE.answerCallOnClientSide();
        webphoneANDagentdesktopANDpowerdialer.PDPreviewFreeCallIE.saveCRMCard();
        webphoneANDagentdesktopANDpowerdialer.PDPreviewFreeCallIE.checkAvailableStatus();
        //PDPreviewFreeAUXsubtests
        ...
        webphoneANDagentdesktopANDpowerdialer.PDPreviewFreeAUXsubtests.receiveIncomingCall();*/
    }
