...
public class TwoLinesAgentHangupv3fast {
    App cxphone;
    Screen screen;
    ...
    WebElement line1;
    WebElement line2;
    WebDriverWait waitForInCallStatus;
    WebElement button_Hangup;
    ...
    public void callOnFirstLine() throws InterruptedException, FindFailed {
    ...
    public void callOnSecondLine() throws InterruptedException, FindFailed {
    ...
    public void agentHangupLine1() throws InterruptedException, FindFailed {
    ...
    public void agentHangupLine2() throws InterruptedException, FindFailed {
        line2 = agentChrome.findElement(By.cssSelector("#btn_line_2"));
        line2.click();
       // Thread.sleep(1000);
    ...
    public void setResultCodeAndCheckAvailableStatus() throws InterruptedException, FindFailed {
